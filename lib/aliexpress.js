...
export async function exchangeCodeForToken(code) {
  ...
  try {
    ...
    // AliExpress kan zowel client_id als app_key verwachten - probeer beide
    const params = {
      grant_type: 'authorization_code',
      code,
      app_key: appKey, // AliExpress gebruikt app_key in plaats van client_id
      app_secret: appSecret, // AliExpress gebruikt app_secret in plaats van client_secret
    ...
    console.log('🔍 Debug - Request parameters (without secrets):', {
      ...
      code: params.code ? '✅ Aanwezig' : '❌ Ontbreekt',
      app_key: params.app_key ? `✅ ${params.app_key.substring(0, 3)}...` : '❌ Ontbreekt',
