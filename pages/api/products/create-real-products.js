...
// REAL PROFESSIONAL PRODUCTS - Based on successful dropshipping stores
export default async function handler(req, res) {
  await connectDB()

  if (req.method === 'POST') {
    try {
      console.log('🏆 Creating REAL Professional Products...')

      // Delete all existing products first
      await Product.deleteMany({})
      console.log('🗑️ Cleared existing products')

      // REAL Professional Products with unique images
      const professionalProducts = [
        {
          name: 'Wireless Phone Charger Stand 15W',
          description: 'Slimme draadloze oplader met stand - perfect voor thuis en kantoor. 15W snelladen, LED indicator, universeel compatibel.',
          costPrice: 8.50,
          price: 24.99,
          originalPrice: 39.99,
          ...
          sku: 'TP-WC-001',
          stock: 500,
          tags: ['wireless', 'charger', 'phone', 'stand', 'fast-charging', '15W'],
          specifications: {
            'Power': '15W',
          ...
          profitMargin: 65,
          images: [
            { url: 'https://images.unsplash.com/photo-1601972602288-d1c1b1b4b4b4?q=80&w=800&auto=format&fit=crop', alt: 'Wireless Charger Stand Main View' },
        ...
        {
          name: 'Magic Cleaning Sponge Set 10 Pack',
          ...
          sku: 'CM-SP-001',
          stock: 1000,
          tags: ['cleaning', 'sponge', 'magic', 'chemical-free', 'versatile', '10-pack'],
          specifications: {
            'Pack Size': '10 pieces',
        ...
        {
          name: 'Car Phone Mount Magnetic Universal',
        ...
        {
          name: 'LED Strip Lights RGB WiFi Smart',
        ...
        },
        {
          ...
          supplier: {
            name: 'BeautyTech EU',
            contact: 'contact@beautytech.eu',
            email: 'supplier@beautytech.eu'
          },
          profitMargin: 67,
          images: [
        ...
        },
        {
          ...
          supplier: {
            name: 'RingTech EU',
            contact: 'contact@ringtech.eu',
            email: 'supplier@ringtech.eu'
          },
          profitMargin: 68,
          images: [
      ...
      console.log(`🏆 REAL Professional Products Created: ${createdProducts.length} products`)

      res.status(200).json({
        success: true,
        message: 'REAL Professional Products created successfully',
        data: {
      ...
      console.error('❌ Professional Products creation failed:', error)
      res.status(500).json({
        success: false,
        message: 'Professional Products creation failed',
        error: error.message
      })
    }
  } else {
